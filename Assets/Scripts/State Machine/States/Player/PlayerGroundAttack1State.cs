...
public class PlayerGroundAttack1State : StateBase<PlayerController>
{
    ...
    public override void Enter()
    {
        ...
        stateTimer = attackActiveDuration; // Inicjalizuj timer
        // Debug.Log($"Enter GroundAttack1State. Duration: {attackActiveDuration}");
        ...
        // Tutaj logika wykrywania trafieñ, aktywacja hitboxa itp.
        // Powinna byæ aktywna przez `attackActiveDuration`.
    }
